/*
This site uses AJAX, so when I realized that I stopped to work on it
Since go.Colly is unable to interact with AJAX (currently 2022)
I'm not able to get data trough pages :(

I'm intend to return here later, but It'll take some months
*/
package server
...
func (m *ReadM) GetMangaDetail(mangaURL string) (manga web.Manga, err error) {
